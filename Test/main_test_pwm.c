...
int main(void)
{
  ...
  */
  ...
  BSP_PWM_EnableTimerChannel1((pwm_cfg_t *) &s_control_llc_data.s_control_gate);
  FCP_PhaseProcess(80500);
...
static void MX_TIM1_Init(void)
{
  ...
  TIM_InitStruct.Prescaler = 373 - 1;
  TIM_InitStruct.CounterMode = LL_TIM_COUNTERMODE_UP;
  TIM_InitStruct.Autoreload = 2 - 1;
