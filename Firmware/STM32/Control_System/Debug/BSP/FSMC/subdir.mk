...
BSP/FSMC/%.o BSP/FSMC/%.su BSP/FSMC/%.cyclo: ../BSP/FSMC/%.c BSP/FSMC/subdir.mk
...
clean: clean-BSP-2f-FSMC

clean-BSP-2f-FSMC:
	-$(RM) ./BSP/FSMC/bsp_fsmc.cyclo ./BSP/FSMC/bsp_fsmc.d ./BSP/FSMC/bsp_fsmc.o ./BSP/FSMC/bsp_fsmc.su

.PHONY: clean-BSP-2f-FSMC
