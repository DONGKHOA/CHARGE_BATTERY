...
/**
 * The function `QUEUE_Init` initializes a ring buffer by setting the input and
 ...
 * @param rb The parameter `rb` is a pointer to a `ring_buffer_t` structure.
 *
 * @return The function `QUEUE_Is_Empty` returns a boolean value indicating
 ...
 *
 * @return The function `QUEUE_Is_Full` is returning a boolean value, either
...
/**
 * The function `QUEUE_Push_Data` adds an element to a ring buffer and updates
 * the buffer's internal variables.
 *
 * @param rb The parameter `rb` is a pointer to a structure of type
 * `ring_buffer_t`.
 * @param element The `element` parameter in the `QUEUE_Push_Data` function
...
/**
 * The function `QUEUE_Pull_Data` pulls data from a ring buffer and updates the
