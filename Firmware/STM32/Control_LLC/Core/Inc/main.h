...
/* Private defines -----------------------------------------------------------*/
#define PFC_ON_OFF_Pin LL_GPIO_PIN_1
#define PFC_ON_OFF_GPIO_Port GPIOA
#define LED_TEST_Pin LL_GPIO_PIN_6
#define LED_TEST_GPIO_Port GPIOA
#define LED_WAIT_Pin LL_GPIO_PIN_0
#define LED_WAIT_GPIO_Port GPIOB
#define LED_SOFT_START_Pin LL_GPIO_PIN_1
