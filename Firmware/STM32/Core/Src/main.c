...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, WR_Pin|RD_Pin|CS_Pin|RESET_Pin
                          |BL_Pin|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14
  ...
  /*Configure GPIO pins : WR_Pin RD_Pin CS_Pin RESET_Pin
                           BL_Pin PE12 PE13 PE14
                           PE15 */
  GPIO_InitStruct.Pin = WR_Pin|RD_Pin|CS_Pin|RESET_Pin
                          |BL_Pin|GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14
                          |GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : D8_Pin D9_Pin D10_Pin D11_Pin
                           D12_Pin D13_Pin D14_Pin D15_Pin
                           D0_Pin D1_Pin D2_Pin D3_Pin
