	...
	//// input /////
	 static double Tri1=0,Tri2=0,T_Sampling=0.00002,IRec_in=0.01,VRec_in=0,VDc_out;///T_Sampling=0.00002
	...
	//////// voltage loop control /////
	 static double Vdc_err,Vdc_reff,Vdc_err_sum,Vdc_P,Vdc_I, Iac_reff=0,Vdc_err_old,Vdc_Sum,Vdc_Exc;
